...
# `migrations` joins the visible tree at Task 2.6, where a student's work is one
# generated revision rather than a change to the application source.
VISIBLE_CONTENT_DIRECTORIES = {"docs", "src", "infra", "tests", "loadtest", "migrations"}
