...
# Task 2.6 assesses one generated migration. Keep this in sync with
# submission_validation.ALLOWED_PATHS and ALLOWED_PREFIXES.
SUBMISSION_DIFF_ALLOWLIST = frozenset({"submission.yaml"})
SUBMISSION_DIFF_PREFIXES = ("migrations/versions/", "tests/student/")
HEADER_FIELDS = (
    "File:",
    "Component:",
    "Purpose:",
...
def test_submission_change_stays_within_the_permitted_diff() -> None:
    """Catch a submitted change that reaches outside Task 2.6's implementation boundary."""
    changed = {
