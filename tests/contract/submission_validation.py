...
Purpose:           Validate Task 2.6 answers and the permitted change paths.
...
ALLOWED_PREFIXES = ("migrations/versions/", "tests/student/")
...
def main(root: Path | None = None, *, changed_paths: list[str] | None = None) -> int:
    ...
    try:
        ...
        return 1
    print("Task 2.6 answer verification passed.")
    return 0
